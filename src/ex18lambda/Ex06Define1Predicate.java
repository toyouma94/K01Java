...
public class Ex06Define1Predicate {
	...
	public static void main(String[] args) {
		/*
		 predicate
		 -사전적의미:~에 근거를 두다
		 -매개변수와 boolean리턴값이 있는 test()계열의 추상메소드를 가지고있다.
		...
		/*
		 ...
		 람다식 정의함 test()메소드를 오버라이딩 하여 정의하였으므로
		 아래와 같이 호출할 수 있다.
		 */
