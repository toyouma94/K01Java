...
public class E05ConstantVa {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 -상수는 딱한번만 초기화되고, 중간에 값을 변경하면 에러발생
		...
		//PI=3.11592; =>에러발생. 상수는 한번 초기화하면 변경 불가.
		...
		int computer, user;
		/*
		 1과 3은 개발자 본인만 알수있는 내용이므로, 가독성이 떨어지는 코드로 작성되었다.
		 */
		computer=1;
		user=3;
		...
		/*
		 PAPER와 같은 단어는 누가 보더라도 이애할수 있으므로 가독성이 높은 명시적인 코드가 된다.
		 */
		computer=SCISSOR;
		user=PAPER;
