...
public class E02SilsuType {
	...
	public static void main(String[] args) {
		...
		//float f4=3.14; =>[에러발생] 3.14자체를 double형으로 인식
		float f4=(float)3.14;//형변환후 대입함(권장사항아님
		System.out.println("f4="+f4);
		
		float f5=3.14F;//접미사 f를 통해 float임을 표현.(권장)
		...
		double d1=3.14;
		double d2=f6+d1;//float+double=double(큰쪽 따라감)
