...
public class E07TypeCasting {
	...
	public static void main(String[] args) {
		...
		/*
		 아랠코드는 자동형변환은 아님. CPU는 int보다 작은 자료형을 int로 간주하고 연산을 진행하며
		...
		/*
		 chat형(문자형타입)에 byte형(숫자타입)을 바로 대입할수 없다.
		...
		/*
		 명시적 형변환: 큰상자의 자료를 작은상자의 자료형에 할당해야 할때 사용함
		 단, 자료의 손실이 있을수 있으므로 필요한 경우에만 사용해야함.
		 */
		short s2= 100;
		byte b2= (byte)s2;
		System.out.printf("데이터미손실:b2=%d, s2=%d\n",b2,s2);
		/*
		 소수점 아래부분이 버려지므로 데이터 손실있음
		 따라서 특수한 경우가 아니라면 사용을 자제해야함.
		 */
		int num3;
		double dl=3.14;
		num3=(int)dl;
		...
		/*
		 char와int를 연산하면 결과는 int이므로 char형 변수에 대입하려면 명시적(강제) 형변환후 대입해야한다.
		 */
		char ch3='A', ch4;
		int num4=2;
		
		//ch4 = ch3 + num4; 타입이 맞지않아 에러발생됨.
		ch4 = (char)(ch3+num4);
