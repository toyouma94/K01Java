...
/*
 switch문
 	...
 	정수식의 값과 동일한 부분을 찾아 실행하는 형태를 가지고있다.
 	형식]
 		switch(정수식or산술식){
 		case 값1:
 			실행문1; break;
 	...
 	-switch문 내부에서 break문을 만나게되면 실행이 중지되고 블럭밖으로 탈출하게된다.
 */
public class E02Switch {
	...
	public static void main(String[] args) {
		...
		/*
		 Scanner클래스
		 	:JDK5.0에 추가된 클래스로 키보드를 통해 사용자로부터 값을 입력받을때 사용함.
		 	nextInt():정수를 입력받음
		 	nextLine():문자열을 입력받음
		 */
		...
		/*
		 ...
		 -byte/short/int/char/string만 사용할수있다.
		 -논리식도 사용이 불가능하다.
		 */
//		long ln=100;
//		switch(ln) {
