...
public class E01StringBasic {
	...
	public static void main(String[] args) {
		 ...
		 */
		if(str1==str2) {
			System.out.println("str2과 str2는 참조주소 같음");
		}
		else {
			System.out.println("str2과 str2는 참조주소 다음");
		}
		/*
		 equals()메소드
		 	:Object 클래스로부터 상속받은 메소드로 실제 저장된 문자열을 비교하도록 만들어진
		...
		/*
		 자바에서 문자열 객체를 생성할때 new를 사용하지 않고"를 사용하면 동일한 문자열인 경우
