...
/*
 StringBuffer 클래스
 	:String클래스는 내부 메소드를 이용해서 새로운 문자열을 생성하면 원래 문자열은
 	변하지 않고 새롭게 생성된 메모리에 문자열을 저장한다. 기존 메모리가 소멸되고 새로운
 	메모리가 생성되는 낭비를 막기위해 StringBuffer클래스가 사용된다.
...
public class E03StringBuilderBuffer {
	...
	public static void main(String[] args) {
		...
		System.out.println("String 과 StringBufferdml의 참조값 비교");
		String str1="코스모";
		String str2="코스모";
		if(str1==str2)
		...
		System.out.println("기본버퍼 크기:"+buf.capacity());
