...
public class Ex05HashMapMain {
	...
	public static void main(String[] args) {
		...
		/*
		 4.중복저장
		 	:기존에 입력된 name 키값이 있으므로"홍길동"이
		 	출력된다.그리고 기존의 값이"최길동"으로 갱신된다.
		 */
		System.out.println("name이라는 키값으로 저장된 이전의 값:"
				+map.put("name","최길동"));//덮어쓰기처리
		...
		/*
		 5-2.키값을 모를때 출력하기
		 	...
		 	※Map계열의 컬렉션은 처음부터 확장 for문을 사용하는 것이
		 	불가능하다. 위처럼 key값을 먼저 얻어온 후 사용해야한다.
		 */
		...
		/*
		 5-3반복자를 통한 출력
		 	:iterator를 통해 반복할때도 keySet()으로 먼저
		 	key를 얻어온 후 사용할 수 있다.
		 */
		...
		/*
		 5-4.Value값만 얻어 올때:values()메소드 사용
		 */
