	...
	public static void main(String[] args) {
		...
		/*
		 List<E>인터페이스 계열의 컬렉션
		 	...
		 	아래와 같이 타입매개변수를 생략하면 모든 객체를 저장할 수 있는
		 	컬렉션이 된다. 즉 ArrayList<Object>로 선언한 것과 동일하다.
		 */
		...
		/*
		 1-3]리스트 컬렉션 출력하기(for,확장for문)
		 	컬렉션을 다룰때는 주로  확장 for(foreach)문을 주로 사용한다.
		 */
		System.out.println("\n[일반 for문 사용]");
		...
		/*
		 ...
		 방법1:인덱스로 삭제하기
		 	remove(index):인덱스를 통해서 삭제를 진행한 후
		 		...
		 		인덱스가 자동으로 재부여된다. 삭제 성공시 해당객체를
		 		반환하므로 어떤객체가 삭제되었는지 확인 가능하다.
		 */
