...
/*
 ...
 Java에서  Naming rule(이름규칙)
 	...
 	-패키지명: simple.func ->전체를 소문자로 표현하고, 연결된 단어가 있더라도 언더바를 사용하지 않는다.
...
public class E02MethodType01 {
	...
	static void noParamNoReturn2() {
		...
		static void noParamNoReturn2(int a) {
			//동일한 이름의 함수가 정의되었으나 매개변수의 갯수로 구분 가능함으로 다른 함수임.
		}
	static void noParamNoReturn3() {
		...
		//return;
		/*
		 위와 같이 함수 중간에 return을 쓰게되면 함수가 즉시 종료 됨으로 아래문장은
		 실행되지 않는 쓰레기코드가 된다. 반드시 조건문과 함께 사용되어야 한다.
		 단, 함수의 마지막 라인에 있는것은 상관없다.
		 */
		if(returnValue%2==0) {
